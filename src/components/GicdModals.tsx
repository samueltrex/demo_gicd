          ...
          <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[80vh] flex-1 space-y-5">
            ...
            {/* Bank Transfer Panel Only */}
              <div className="p-4 bg-amber-50/70 border border-amber-100 rounded-xl space-y-3">
                ...
                *Please type &quot;GICD Donate&quot; as your transfer note. Send screenshot to info@thegicd.org or submit form below for verification.
              </p>
              </div>
          ...
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-5 animate-scale-up" id="donate-success-screen">
            ...
            <div className="text-center space-y-3 w-full">
              <p className="text-[11px] text-gray-500 italic leading-relaxed">
                * Please email your bank transfer receipt/screenshot to: <span className="underline font-bold text-brand-black">info@thegicd.org</span> for verification.
              </p>
              
              <a
                href={`https://mail.google.com/mail/?view=cm&fs=1&to=info@thegicd.org&su=${encodeURIComponent(`GICD Donation Proof: ₦${Number(activeAmount).toLocaleString()} - ${formData.name}`)}&body=${encodeURIComponent(`Hello GICD Admin,\n\nI have made a direct bank transfer of ₦${Number(activeAmount).toLocaleString()} for GICD Community projects.\n\nName: ${formData.name}\nEmail: ${formData.email}`)}`}
                target="_blank"
        ...
        {step === "form" ? (
          ...
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-5" id="volunteer-success-screen">
            ...
            <p className="text-[10px] text-gray-500 italic max-w-xs">
              Next step: Your application has been sent to our volunteer coordination team at <span className="font-semibold text-brand-black">info@thegicd.org</span>. Please check your inbox or WhatsApp for an invitation shortly.
            </p>
        ...
        {step === "form" ? (
          ...
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-5" id="partner-success-screen">
            ...
            <p className="text-[10px] text-gray-400 max-w-xs">
              Your proposal has been routed to <span className="font-semibold text-brand-black">info@thegicd.org</span>. Our Public Relations team will contact you within 48 hours with technical compliance documents.
            </p>
        ...
        {step === "form" ? (
          ...
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-5" id="job-success-screen">
            ...
            <p className="text-[10px] text-gray-400 max-w-xs leading-relaxed text-center">
              Your application has been routed to our recruitment desk at <span className="font-semibold text-brand-black">info@thegicd.org</span>. Our Recruitment Desk led by Iliya John Dayok (licensed CIPM professional) will contact you within 5–7 working days for initial screening.
            </p>
